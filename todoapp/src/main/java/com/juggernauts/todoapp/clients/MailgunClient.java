...
import com.juggernauts.todoapp.configurations.MailgunConfiguration;
 ...
 * @author Jacob
 */
@FeignClient(contextId="mailgunClient", name="mailService", url="https://api.mailgun.net/v3/sandbox2f4262e762e340fe926e9817e52a3ca1.mailgun.org", configuration=MailgunConfiguration.class)
